...
class PaginaRipetizioniTot extends StatefulWidget {
  @override
  State<PaginaRipetizioniTot> createState() => _PaginaRipetizioniTotState();
}
...
class _PaginaRipetizioniTotState extends State<PaginaRipetizioniTot> {
  ...
  final _widgetOptions = [PaginaRipetizioniTot()];
